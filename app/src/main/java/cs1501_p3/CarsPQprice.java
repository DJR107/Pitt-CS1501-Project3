		...
		else
		{
			...
			while (index > 0)
			{
				...
				if (index % 2 == 1)
				{
					...
					//System.out.println("Parent Price: "+parent.getCar().getPrice())''

					if (c.getPrice() < parent.getPrice())
					{
						//System.out.println("Needs Swapping");
						carArray[(2*index)+1] = parent;
						//System.out.println("New Left Price: "+parent.getLeft().getCar().getPrice());
					}
					else
					{
				...
				else if (index % 2 == 0)
				{
					...
					if (c.getPrice() < parent.getPrice())
					{
						...
						//System.out.println("New Right Price: "+parent.getRight().getCar().getPrice());
					}
					else
					{
						//System.out.println("No Swapping Needed");
				...
				if (index == 0)
				{
					...
					carArray[index] = c;
					//System.out.println("New Root Price: "+root.getCar().getPrice());
				}
			}
		}
		size++;
